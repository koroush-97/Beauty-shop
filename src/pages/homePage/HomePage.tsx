...
function HomePage() {
  return (
    <section className="relative  main-section h-auto py-2 ">
      <div className=" patronage-part my-25  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 p-2 gap-x-5 gap-y-2 justify-center items">
        <div>
          <WrappernBox>
            <FeatureBox
      ...
      <div className="CategorySection relative  min-h-87.5 md:h-auto z-0  flex justify-center items-center">
        {/* ---layer---- */}
        <div className=" underlayer border absolute top-0 bottom-0 right-0 left-0 z-10 "></div>
        {/* ---content-layer--- */}
        ...
        >
          ...
          <div
            dir="rtl"
            className="flex flex-row  order-1 lg:order-3 shadow-[0_8px_24px_-6px_rgba(0,0,0,0.2)] rounded-3xl"
          >
            ...
            <div className="hidden p-1 md:flex justify-center items-center md:w-[20%] lg:hidden  ">
          ...
          >
            <div className=" flex justify-center items-center ">
              <WrappernBox height="85%" width="100%">
          ...
          >
            <div className=" rounded-xl p-2 flex justify-center items-center flex-row gap-x-2 shadow-[0_8px_24px_-6px_rgba(0,0,0,0.4)] h-[70%]">
              <Link
                to="#"
                dir="ltr"
                className="border border-lightback p-5 rounded-2xl hover:bg-lightback"
              >
